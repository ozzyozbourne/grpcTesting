...
public final class ComplexOuterClass {
  ...
  public interface ComplexOrBuilder extends
    ...
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     * @return Whether the dummyOne field is set.
     */
    boolean hasDummyOne();
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     * @return The dummyOne.
     */
    example.complex.ComplexOuterClass.Dummy getDummyOne();
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     */
    example.complex.ComplexOuterClass.DummyOrBuilder getDummyOneOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              if (dummyOne_ != null) {
                subBuilder = dummyOne_.toBuilder();
              }
              dummyOne_ = input.readMessage(example.complex.ComplexOuterClass.Dummy.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(dummyOne_);
                dummyOne_ = subBuilder.buildPartial();
              }
    ...
    public static final int DUMMY_ONE_FIELD_NUMBER = 1;
    private example.complex.ComplexOuterClass.Dummy dummyOne_;
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     * @return Whether the dummyOne field is set.
     */
    @java.lang.Override
    public boolean hasDummyOne() {
      return dummyOne_ != null;
    }
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     * @return The dummyOne.
     */
    @java.lang.Override
    public example.complex.ComplexOuterClass.Dummy getDummyOne() {
      return dummyOne_ == null ? example.complex.ComplexOuterClass.Dummy.getDefaultInstance() : dummyOne_;
    }
    /**
     * <code>.example.complex.Dummy dummy_one = 1;</code>
     */
    @java.lang.Override
    public example.complex.ComplexOuterClass.DummyOrBuilder getDummyOneOrBuilder() {
      return getDummyOne();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (dummyOne_ != null) {
        output.writeMessage(1, getDummyOne());
      }
    ...
    public int getSerializedSize() {
      ...
      if (dummyOne_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getDummyOne());
      }
      for (int i = 0; i < dummies_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasDummyOne() != other.hasDummyOne()) return false;
      if (hasDummyOne()) {
        if (!getDummyOne()
            .equals(other.getDummyOne())) return false;
      }
      if (!getDummiesList()
    ...
    public int hashCode() {
      ...
      hash = (19 * hash) + getDescriptor().hashCode();
      if (hasDummyOne()) {
        hash = (37 * hash) + DUMMY_ONE_FIELD_NUMBER;
        hash = (53 * hash) + getDummyOne().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        if (dummyOneBuilder_ == null) {
          dummyOne_ = null;
        } else {
          dummyOne_ = null;
          dummyOneBuilder_ = null;
        }
      ...
      public example.complex.ComplexOuterClass.Complex buildPartial() {
        ...
        if (dummyOneBuilder_ == null) {
          result.dummyOne_ = dummyOne_;
        } else {
          result.dummyOne_ = dummyOneBuilder_.build();
        }
        if (dummiesBuilder_ == null) {
      ...
      public Builder mergeFrom(example.complex.ComplexOuterClass.Complex other) {
        ...
        if (other.hasDummyOne()) {
          mergeDummyOne(other.getDummyOne());
        }
        if (dummiesBuilder_ == null) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          example.complex.ComplexOuterClass.Dummy, example.complex.ComplexOuterClass.Dummy.Builder, example.complex.ComplexOuterClass.DummyOrBuilder> dummyOneBuilder_;
      /**
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       * @return Whether the dummyOne field is set.
       */
      public boolean hasDummyOne() {
        return dummyOneBuilder_ != null || dummyOne_ != null;
      }
      /**
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       * @return The dummyOne.
      ...
      public example.complex.ComplexOuterClass.Dummy getDummyOne() {
        if (dummyOneBuilder_ == null) {
          ...
          return dummyOneBuilder_.getMessage();
        }
      }
      /**
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       */
      public Builder setDummyOne(example.complex.ComplexOuterClass.Dummy value) {
        if (dummyOneBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ...
          dummyOneBuilder_.setMessage(value);
        }
       ...
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       */
      public Builder setDummyOne(
          example.complex.ComplexOuterClass.Dummy.Builder builderForValue) {
        if (dummyOneBuilder_ == null) {
          dummyOne_ = builderForValue.build();
          onChanged();
        } else {
          dummyOneBuilder_.setMessage(builderForValue.build());
        }
       ...
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       */
      public Builder mergeDummyOne(example.complex.ComplexOuterClass.Dummy value) {
        if (dummyOneBuilder_ == null) {
          if (dummyOne_ != null) {
            dummyOne_ =
              example.complex.ComplexOuterClass.Dummy.newBuilder(dummyOne_).mergeFrom(value).buildPartial();
          } else {
            dummyOne_ = value;
          }
          onChanged();
        } else {
          dummyOneBuilder_.mergeFrom(value);
        }
       ...
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       */
      public example.complex.ComplexOuterClass.Dummy.Builder getDummyOneBuilder() {
        
        onChanged();
        return getDummyOneFieldBuilder().getBuilder();
      }
      /**
       * <code>.example.complex.Dummy dummy_one = 1;</code>
       */
      public example.complex.ComplexOuterClass.DummyOrBuilder getDummyOneOrBuilder() {
        if (dummyOneBuilder_ != null) {
          return dummyOneBuilder_.getMessageOrBuilder();
        } else {
          return dummyOne_ == null ?
              example.complex.ComplexOuterClass.Dummy.getDefaultInstance() : dummyOne_;
        }
      }
      /**
       * <code>.example.complex.Dummy dummy_one = 1;</code>
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ...
          getDummyOneFieldBuilder() {
        if (dummyOneBuilder_ == null) {
          dummyOneBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              example.complex.ComplexOuterClass.Dummy, example.complex.ComplexOuterClass.Dummy.Builder, example.complex.ComplexOuterClass.DummyOrBuilder>(
                  getDummyOne(),
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\tdummy_one\030\001 \001(\0132\026.example.complex.Dumm" +
    ...
    internal_static_example_complex_Complex_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_example_complex_Complex_descriptor,
        new java.lang.String[] { "DummyOne", "Dummies", });
  }
